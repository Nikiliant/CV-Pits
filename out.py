...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_3.clicked.connect(self.lineEdit_2.copy)
        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Form"))
        self.label_2.setText(_translate("Form", "Выходной каталог"))
        self.pushButton.setText(_translate("Form", "..."))
        self.pushButton_2.setText(_translate("Form", "..."))
        self.label.setText(_translate("Form", "Входной файл"))
        self.pushButton_3.setText(_translate("Form", "Начать"))
